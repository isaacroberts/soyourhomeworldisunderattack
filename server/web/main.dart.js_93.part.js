...
$__dart_deferred_initializers__.current = function(hunkHelpers, init, holdersList, $) {
  ...
  B._RpgIconDisplay.prototype = {
    ...
    build$1(context) {
      var _null = null,
        ...
        t2 = A.Border_Border$all(D.Color_lrU, -1, 1),
        t3 = C.TextStyle_1Kq.copyWith$1$fontSize(12);
      return A.Center$(A.Container$(_null, A.Tooltip$(F.MaterialButton$(A.Icon$(inBounds ? G.List_yDx[t1] : _null, _null, _null, 50), _null, _null, this.get$copyText(), _null), D.BoxDecoration_zvS, _null, false, _null, C.Duration_0, $name + " (" + t1 + ")", _null, t3, _null, C.Duration_1000000), C.Clip_0, _null, _null, new A.BoxDecoration(_null, _null, t2, _null, _null, _null, C.BoxShape_0), _null, _null, _null, _null, C.EdgeInsets_15_15_15_15, _null, _null, _null), _null, _null);
    }
  };
  B.IconViewerPage.prototype = {
    build$1(context) {
      return new A.McScaffold("dev_icon", E.GridView$builder(D.SliverGridDelegateWithFixedCrossAxisCount_0_0_null, new B.IconViewerPage_build_closure(), 496), true, null);
    }
  };
  ...
  (function constants() {
    ...
    D.Color_lrU = new A.Color(0.5333333333333333, 0.4, 0.4, 0.4, C.ColorSpace_0);
    ...
    D.SliverGridDelegateWithFixedCrossAxisCount_0_0_null = new E.SliverGridDelegateWithFixedCrossAxisCount(0, 0, null);
  })();
};
;
((d, h) => {
...
})($__dart_deferred_initializers__, "6bPsJ62bXUYtds7cFqP2btmwH0k=");
;

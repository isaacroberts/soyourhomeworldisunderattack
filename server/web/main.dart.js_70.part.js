...
D.OO.prototype={
B(d){var x=null,w=B.hx(15),v=y.l
return B.br(C.y,new B.dc(C.bq,x,C.aN,C.w,B.b([B.atr(M.b6w(A.UH,x,0.1),A.a_K,!1),A.ES,A.ET,new B.bG(A.F_,x,x,B.br(x,x,C.l,x,x,new B.bt(x,x,B.dO(A.IF,-1,8),x,x,x,C.eh),x,150,x,x,x,x,x,150),x),A.EP,new B.bG(A.EY,x,x,B.ah("\ud83d\udc49\ufe0f",x,x,x,x,x,C.aW.a07(C.m,60,B.b([A.a2T],v)),x,x),x),new B.bG(A.F0,x,x,B.ah("\ud83e\udd2f\ufe0f",x,x,x,x,x,C.aW.a07(C.m,60,B.b([A.a2S],v)),x,x),x)],y.e),x),C.l,x,x,new B.bt(x,x,x,w,x,A.VQ,C.N),x,x,x,C.Q,C.Q,x,x,x)}}
var z=a.updateTypes([])
D.a7G.prototype={
$0(){var x=this.a.b
if(x==null)x="YTHook"
...
x(B.Q,[D.XK,D.XV,D.OO])
w(D.ON,F.dF)
w(D.a7G,B.e7)})()
B.bL(b.typeUniverse,JSON.parse('{"XK":{"Q":[],"c":[]},"ON":{"dF":[],"aR":[]},"XV":{"Q":[],"c":[]},"OO":{"Q":[],"c":[]}}'))
...
A.a2R=new B.jw(A.K1,C.xS,15)
A.XZ=B.b(x([A.a2R]),y.l)
A.UD=new B.dI(A.Uz,100,C.Jk,A.XZ,null,null)
A.EP=new B.bG(A.F1,null,null,A.UD,null)
A.EZ=new B.d7(-0.33,1)
A.qQ=new B.f(58213,"MaterialIcons",null,!1)
A.JF=new B.n(1,0.5333333333333333,0.2823529411764706,0.09803921568627451,C.e)
A.UO=new B.dI(A.qQ,150,A.JF,null,null,null)
A.ES=new B.bG(A.EZ,null,null,A.UO,null)
A.Jm=new B.n(1,0.34901960784313724,0.1450980392156863,0,C.e)
A.UP=new B.dI(A.qQ,300,A.Jm,null,null,null)
A.ET=new B.bG(K.ef,null,null,A.UP,null)
...
A.IF=new B.n(0.8,1,0.12941176470588237,0.06666666666666667,C.e)
A.LG=new B.ac(0,24,0,24)
A.K2=new B.n(1,0.26666666666666666,0.4666666666666667,0.26666666666666666,C.e)
A.UH=new B.dI(H.lX,500,A.K2,null,null,null)
...
A.IN=new B.n(0.30980392156862746,0,0,0,C.e)
A.a2T=new B.jw(A.IN,C.h0,5)

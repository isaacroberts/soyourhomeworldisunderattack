...
$__dart_deferred_initializers__.current=function(a,b,c,$){var A,B,G,H,D={
b5x(d){var x=new D.WV(),w=H.aKD(d),v=A.b(w.split(":"),y.h),u=v[0]
if(B.c.m(u,"@"))x.a=A.h_(u,"@","")
else if(B.c.m(w,"@"))A.ad(new I.Cu("Not implemented - Username in tweet hard to reach. list=("+A.o(v)+'}) text="'+w+'"'))
else x.a=u
if(v.length>1)x.b=B.b.bw(B.b.f4(v,1),":")
else x.b="Exception: Tweet JSON unparseable."
return x},
WV:function WV(){this.b=this.a=$},
...
x=this.b
x===$&&A.a()
return new D.yv(w,x,null)},
ct(d){var x,w=this.a
w===$&&A.a()
x=this.b
x===$&&A.a()
return A.Si(new D.yv(w,x,null),!1)},
d7(){var x,w=this.a
w===$&&A.a()
x=this.b
x===$&&A.a()
...
D.VE.prototype={
T(d){if(d.m(0,B.B))return B.Ic
if(d.m(0,B.t))return C.Ij
return C.oX}}
var z=a.updateTypes(["~()"]);(function installTearOffs(){var x=a._instance_0u
x(D.yv.prototype,"gaAu","aAv",0)})();(function inheritance(){var x=a.inherit
x(D.WV,A.aO)
x(D.yv,A.R)
x(D.VE,A.fC)})()
A.bL(b.typeUniverse,JSON.parse('{"WV":{"aO":[]},"yv":{"R":[],"c":[]},"VE":{"fC":[],"n":[],"aZ":["n"]}}'))
var y={h:A.Q("r<l>"),e:A.Q("r<c>")};(function constants(){C.pA=new A.n(1,0.30196078431372547,0.6470588235294118,0.9137254901960784,B.e)
C.Uv=new A.dG(B.lU,null,C.pA,null,null,null)
C.EK=new A.bK(K.hw,null,null,C.Uv,null)
C.FH=new A.bu(C.pA,null,null,null,null,null,B.ef)
C.Ih=new A.n(0.5019607843137255,0.4,0.4196078431372549,0.4392156862745098,B.e)
C.Fl=new A.bd(C.Ih,1,B.G,-1)
C.Fp=new A.dn(C.Fl,B.p,B.p,B.p)
C.FJ=new A.bu(null,null,C.Fp,null,null,null,B.N)
C.Ij=new A.n(1,0.5333333333333333,0.4823529411764706,0.5647058823529412,B.e)
C.oX=new A.n(1,0.4,0.4196078431372549,0.4392156862745098,B.e)
C.IM=new A.n(1,0.8941176470588236,0.8980392156862745,0.9058823529411765,B.e)
C.Lw=new A.ai(0,5,0,5)
C.q7=new A.ai(10,10,10,10)
C.LM=new A.ai(30,30,30,30)
C.Je=new A.n(0.5333333333333333,0,0,0,B.e)
C.UC=new A.dG(E.qU,null,C.Je,null,null,null)
C.a3F=new A.aw(15,null,null,null)

...
$__dart_deferred_initializers__.current=function(a,b,c,$){var A,C,E,F,B={afj:function afj(d){this.a=d
this.b=null},
b3h(d){return new B.RO(d)},
...
gkg(){var x,w=this.b
if(w==null){w=$.DV
if(w==null)w=$.DV=new A.DU(A.x(y.e,y.s))
x=this.a.d
x.toString
x=this.b=w.a5T(x)
w=x}return w},
c8(d){return this.aCQ(d)},
aCQ(d){var x=0,w=A.J(y.b),v,u=this,t
...
B.wk.prototype={
Y(){var x=null
return new B.Kr(A.iS(x,0,!0,x),x,x)}}
B.Kr.prototype={
ak(){var x=this,w=A.yU(C.bC,x.gLw())
x.e!==$&&A.aX()
x.e=w
$.aMd().c8("ElvenChorus")
x.aA()},
...
v=C.b.gcq(w).at
v.toString
if(v===0)x.hX(u.gm4()+10,C.T,A.dA(0,C.e.fu(u.gm4()*u.gQP()),0,0))
else{w=C.b.gcq(w).at
w.toString
if(w>=u.gm4()-30)if(u.a.c!==1)x.ey(0)
else x.hX(0,C.hw,A.dA(0,C.e.fu(u.gm4()*u.gQP()*3),0,0))}}},
l(){var x=this.e
x===$&&A.a()
x.aM()
this.d.l()
...
a6n(d){return 2100},
awN(d){var x=null
return new A.bo(C.fh,x,x,A.ad(d,x,1,x,x,x,$.aMd().a.x7(48,1),x,x),x)},
PC(d){var x=null
return new A.bo(C.fh,x,x,A.ad(d,x,1,x,x,x,$.aMd().a,x,x),x)},
rn(d){return new A.dM(this.a7C(d),y.p)},
a7C(d){return function(){var x=d
var w=0,v=1,u=[],t,s,r
...
aGB(){var x,w,v,u,t,s=this,r=A.b([],y.u)
r.push(E.c0)
x=s.rn("A Elbereth! Gilthoniel!")
w=y.l
v=A.ku(x,s.gawM(),x.$ti.h("K.E"),w)
for(x=s.gPB(),u=0;u<1;++u){t=s.rn(D.Yp[u])
C.b.a2(r,A.ku(t,x,t.$ti.h("K.E"),w))
r.push(D.a5q)
C.b.a2(r,v)
...
w=v.f
w===$&&A.a()
return A.eu(new A.aq(x,72,A.TL(w,v.d,u,!1,C.a6,!1),u),u,u,u,!0,u,u,u,'"Passing of the Elves"\nfrom Lord of the Rings',u,u,u,u,u,u,u)}}
B.Oq.prototype={
l(){var x=this,w=x.bd$
if(w!=null)w.G(x.geZ())
x.bd$=null
...
this.bT()
this.f_()}}
var z=a.updateTypes(["c(m)","~(@)"]);(function aliases(){var x=B.Oq.prototype
x.abT=x.l})();(function installTearOffs(){var x=a._instance_1u
var w
x(w=B.Kr.prototype,"gLw","q3",1)
x(w,"gawM","awN",0)
...
w(B.Kr,B.Oq)
x(B.Oq,A.eg)})()
A.bh(b.typeUniverse,JSON.parse('{"wk":{"Q":[],"c":[]},"RO":{"b5":[]},"Kr":{"T":["wk"]}}'))
...
x($,"bkB","aMd",()=>new B.afj(D.aaA))})()};
((a,b)=>{a[b]=a.current
a.eventLog.push({p:"main.dart.js_64",e:"endPart",h:b})})($__dart_deferred_initializers__,"TamkVrDSyLAuficYQI1nMljpKcM=");
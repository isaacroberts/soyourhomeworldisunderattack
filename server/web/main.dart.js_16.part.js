...
$__dart_deferred_initializers__.current = function(hunkHelpers, init, holdersList, $) {
  var A, C,
  B = {
    SingleChildScrollView$(child, controller, key, physics, scrollDirection) {
      return new B.SingleChildScrollView(scrollDirection, controller, physics, child, key);
    },
  ...
  B.SingleChildScrollView.prototype = {
    build$1(context) {
      var effectivePrimary, scrollController, scrollable, effectiveKeyboardDismissBehavior, _this = this, _null = null, t1 = {},
        t2 = _this.scrollDirection,
        axisDirection = A.getAxisDirectionFromAxisReverseAndDirectionality(context, t2, false);
      t1.contents = _this.child;
      effectivePrimary = _this.controller == null && A.PrimaryScrollController_shouldInherit(context, t2);
      scrollController = effectivePrimary ? A.PrimaryScrollController_maybeOf(context) : _this.controller;
      scrollable = A.Scrollable$(axisDirection, C.Clip_1, scrollController, C.DragStartBehavior_1, false, C.HitTestBehavior_1, _null, _this.physics, _null, _null, _null, new B.SingleChildScrollView_build_closure(t1, _this, axisDirection));
      effectiveKeyboardDismissBehavior = A.ScrollConfiguration_of(context).getKeyboardDismissBehavior$1(context);
      if (effectiveKeyboardDismissBehavior === C.ScrollViewKeyboardDismissBehavior_1)
        scrollable = new A.NotificationListener(new B.SingleChildScrollView_build_closure0(context), scrollable, _null, type$.NotificationListener_ScrollUpdateNotification);
  ...
  B._SingleChildViewport.prototype = {
    createRenderObject$1(context) {
      var t1 = new B._RenderSingleChildViewport(this.axisDirection, this.offset, this.clipBehavior, A.LayerHandle$(type$.ClipRectLayer), null, new A._LayoutCacheStorage(), A.LayerHandle$(type$.ContainerLayer));
      t1.RenderObject$0();
      t1.set$child(null);
      return t1;
    },
  ...
  B._RenderSingleChildViewport.prototype = {
    ...
    _single_child_scroll_view$_getInnerConstraints$1(constraints) {
      var t1;
      switch (A.axisDirectionToAxis(this._single_child_scroll_view$_axisDirection).index) {
        case 0:
    ...
    computeDryLayout$1(constraints) {
      ...
      return constraints.constrain$1(t1._computeIntrinsics$3(C.C__DryLayout, this._single_child_scroll_view$_getInnerConstraints$1(constraints), t1.get$_computeDryLayout()));
    },
    performLayout$0() {
      ...
      if (t1 == null)
        ...
        t1.layout$2$parentUsesSize(_this._single_child_scroll_view$_getInnerConstraints$1(constraints), true);
  ...
  B.SingleChildScrollView_build_closure0.prototype = {
    call$1(notification) {
      var t1,
  ...
  (function inheritance() {
    ...
    _inherit(B.SingleChildScrollView_build_closure0, A.Closure);
    ...
    _mixin(B.__SingleChildViewportElement_SingleChildRenderObjectElement_NotifiableElementMixin_ViewportElementMixin, A.ViewportElementMixin);
  })();
  ...
  var type$ = {
    ...
    NotificationListener_ScrollUpdateNotification: A.findType("NotificationListener<ScrollUpdateNotification>")
  };
};
;
((d, h) => {
...
})($__dart_deferred_initializers__, "kYZ8idQ8kf8f3CIs8bqwuS9/eZI=");
;
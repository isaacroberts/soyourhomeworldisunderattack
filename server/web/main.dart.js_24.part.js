...
x=this.b=w.a5r(x)
w=x}return w},
b9(){var x=0,w=A.O(y.b),v,u=this,t
var $async$b9=A.I(function(d,e){if(d===1)return A.L(e,w)
while(true)switch(x){case 0:x=3
return A.H(u.gkb().b9(),$async$b9)
case 3:t=u.gkb()
t.toString
v=t
x=1
...
var w=0,v=1,u=[],t,s,r
return function $async$G7(e,f,g){if(f===1){u.push(g)
w=v}while(true)switch(w){case 0:t=x.length,s=0
case 2:if(!(s<t)){w=4
break}r=s+100
w=5
return e.b=C.c.a8(x,s,Math.min(r,t)),1
case 5:case 3:s=r
w=2
break
case 4:return 0
case 1:return e.c=u.at(-1),3}}}},
aFT(){var x,w,v,u,t,s=this,r=A.b([],y.u)
r.push(C.hg)
x=s.G7("A Elbereth! Gilthoniel!")
w=y.l
v=A.ln(x,s.gawv(),x.$ti.h("D.E"),w)
for(x=s.gaGB(),u=0;u<1;++u){t=s.G7(D.X9[u])
C.b.a1(r,A.ln(t,x,t.$ti.h("D.E"),w))
r.push(D.a3Z)
C.b.a1(r,v)
r.push(C.hg)}r.push(new A.as(s.r,null,null,null))
r.push(C.hg)
return r},
B(d){var x,w,v=this,u=null,t=A.b2(d,C.bK,y.x).w.a.a
if(v.w>0&&t!==v.r){x=v.f
x===$&&A.a()
w=v.r
x[0]=new A.as(w,u,u,u)
C.b.san(x,new A.as(w,u,u,u))}v.r=t
if(v.w<=0){v.w=v.a5Q(d)
x=v.aFT()
v.f!==$&&A.b1()
v.f=x}x=v.r
w=v.f

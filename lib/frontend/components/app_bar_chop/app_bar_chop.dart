...
import 'package:soyourhomeworld/frontend/components/app_bar_chop/sliver_persistent_header_chop.dart';
...
class _PreferredAppBarSize extends Size {
  _PreferredAppBarSize(this.toolbarHeight)
      : super.fromHeight((toolbarHeight ?? kToolbarHeight) + (0));

  final double? toolbarHeight;
}

class AppBarChop extends StatefulWidget implements PreferredSizeWidget {
  ...
  /// Used by [Scaffold] to compute its [AppBarChop]'s overall height. The returned value is
  /// the same `preferredSize.height` unless [AppBarChop.toolbarHeight] was null and
  ...
  /// the app bar's [AppBarChop.bottom] widget.
  ...
  /// then [AppBarChop] uses the overall theme's [ColorScheme.primary] if the
  /// overall theme's brightness is [Brightness.light], and [ColorScheme.surface]
  /// if the overall theme's brightness is [Brightness.dark].
  /// In Material v3 (i.e., when [ThemeData.useMaterial3] is true),
  /// then [AppBarChop] uses the overall theme's [ColorScheme.surface]
  ///
  ...
  /// value is also null:
  /// In Material v2 (i.e., when [ThemeData.useMaterial3] is false),
  /// then [AppBarChop] uses the overall theme's [ColorScheme.onPrimary] if the
  /// overall theme's brightness is [Brightness.light], and [ColorScheme.onSurface]
  /// if the overall theme's brightness is [Brightness.dark].
  /// In Material v3 (i.e., when [ThemeData.useMaterial3] is true),
  /// then [AppBarChop] uses the overall theme's [ColorScheme.onSurface].
  ///
  ...
  /// Defines the height of the toolbar component of an [AppBarChop].
  ///
  ...
  /// Defines the width of [AppBarChop.leading] widget.
  ///
  /// By default, the value of [AppBarChop.leadingWidth] is 56.0.
  /// {@endtemplate}
  final double? leadingWidth;

  /// {@template flutter.material.appbar.toolbarTextStyle}
  /// The default text style for the AppBarChop's [leading], and
  ...
  /// The default text style for the AppBarChop's [title] widget.
  ///
  ...
  /// See also:
  ///
  ///  * [toolbarTextStyle], which is the default text style for the AppBarChop's
  ///    [title], [leading], and [actions] widgets, also known as the
  ///    AppBarChop's "toolbar".
  ///  * [DefaultTextStyle], which overrides the default text style for all of the
  ///    widgets in a subtree.
  ...
  ///
  /// The AppBarChop's descendants are built within a
  /// `AnnotatedRegion<SystemUiOverlayStyle>` widget, which causes
  /// [SystemChrome.setSystemUIOverlayStyle] to be called
  /// automatically. Apps should not enclose an AppBarChop with their
  /// own [AnnotatedRegion].
  /// {@endtemplate}
  //
  /// See also:
  ...
  /// The padding between the [actions] and the end of the AppBarChop.
  ///
  /// Defaults to zero.
  /// {@endtemplate}
  ...
  @override
  State<AppBarChop> createState() => _AppBarState();
}

class _AppBarState extends State<AppBarChop> {
...
class _SliverAppBarDelegate extends SliverPersistentHeaderChopDelegate {
  ...
  double get maxExtent => math.max(
        topPadding + (expandedHeight ?? (toolbarHeight ?? kToolbarHeight)),
        minExtent,
      );
  ...
  @override
  String toString() {
    return '${describeIdentity(this)}(topPadding: ${topPadding.toStringAsFixed(1)}, ...)';
  }
}
...
/// the screen see [AppBarChop], which is used in the [Scaffold.appBar] slot.
///
/// The AppBarChop displays the toolbar widgets, [leading], [title], and
...
class SliverAppBarChop extends StatefulWidget {
  /// Creates a Material Design app bar that can be placed in a [CustomScrollView].
  const SliverAppBarChop({
    super.key,
    this.leading,
    this.title,
    this.actions,
  ...
  ///
  /// This property is used to configure an [AppBarChop].
  final Widget? leading;
  ...
  /// content is not scrolled under the [AppBarChop].
  ///
  /// Defaults to false, meaning that the [elevation] is only applied when the
  /// [AppBarChop] is being displayed over content that is scrolled under it.
  ///
  ...
  @override
  State<SliverAppBarChop> createState() => _SliverAppBarState();
}

// This class is only Stateful because it owns the TickerProvider used
// by the floating appbar snap animation (via FloatingHeaderSnapConfiguration).
class _SliverAppBarState extends State<SliverAppBarChop>
  ...
  Widget build(BuildContext context) {
    ...
    final double collapsedHeight =
        (widget.collapsedHeight ?? widget.toolbarHeight) + topPadding;
    ...
    switch (widget._variant) {
      ...
      case _SliverAppVariant.medium:
        effectiveExpandedHeight = widget.expandedHeight ??
            _MediumScrollUnderFlexibleConfig.expandedHeight;
        effectiveCollapsedHeight = widget.collapsedHeight ??
            topPadding + _MediumScrollUnderFlexibleConfig.collapsedHeight;
        effectiveFlexibleSpace = widget.flexibleSpace ??
      ...
      case _SliverAppVariant.large:
        effectiveExpandedHeight = widget.expandedHeight ??
            _LargeScrollUnderFlexibleConfig.expandedHeight;
        effectiveCollapsedHeight = widget.collapsedHeight ??
            topPadding + _LargeScrollUnderFlexibleConfig.collapsedHeight;
        effectiveFlexibleSpace = widget.flexibleSpace ??
            _ScrollUnderFlexibleSpace(
              title: widget.title,
              foregroundColor: widget.foregroundColor,
    ...
    return MediaQuery.removePadding(
      context: context,
      removeBottom: true,
      child: SliverPersistentHeaderChop(
...
// Layout the AppBarChop's title with unconstrained height, vertically
...
class _ScrollUnderFlexibleSpace extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final EdgeInsetsGeometry expandedTitlePadding = resolvedTitlePadding;
...
// visible when the AppBarChop is fully expanded.
...
class _RenderExpandedTitleBox extends RenderShiftedBox {
  ...
  Offset _childOffsetFromSize(Size childSize, Size size) {
    ...
    // the visible vertical space when AppBarChop is fully expanded. The goal is to
...
// BEGIN GENERATED TOKEN PROPERTIES - AppBarChop
...
// END GENERATED TOKEN PROPERTIES - AppBarChop
